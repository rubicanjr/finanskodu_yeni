...
--> statement-breakpoint
ALTER TABLE "analysisResults" ADD CONSTRAINT "analysisResults_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
