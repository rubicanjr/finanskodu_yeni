...
const product = {
  ...
  summaryItems: [
    '100+ test edilmiş finansal AI prompt',
    'ChatGPT ve Claude ile uyumlu şablonlar',
    'Temel analiz, teknik analiz, portföy yönetimi kategorileri',
    'Hazır kopyala-yapıştır formatı',
    'Düzenli güncelleme ve yeni prompt eklemeleri',
    'Başlangıç → İleri seviye zorluk sınıflandırması',
  ],
  thirtyDayItems: [
    'Finansal raporları AI ile dakikalar içinde analiz et',
    'Portföy optimizasyon modelini otomatikleştir',
    'Haber akışını piyasa etkisi açısından filtrele',
    'Teknik analiz yorumlarını hızlandır',
    'Kendi özel prompt kütüphaneni oluştur',
  ],
};
